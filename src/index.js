...
export default {
	async fetch(request, env, ctx) {
		...
		const sPrompt = `
			...
			1. תיאור העניין המשפטי של המסמך. הכותרת היא *2*עניין משפטי*2*
			...
			4. החלטת השופט והסיבות שהובילו אותו להחלטה זו. הכותרת היא *2*החלטה וסיבות*2*. אנא השתמש במונחים משפטיים
			בחלק התחומים עליך לכתוב את התחומים המשפטיים שקשורים למסמך, עד עשרה תחומים ועם פסיק שמפריד ביניהם
		`;
